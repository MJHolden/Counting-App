...
function App() {
  ...
  return (
    <div className="App">
      ...
      <button
        onClick={decrementNumberClick}
        disabled={number === 0}
        className="btn"
      >
        -
      </button>
      <button onClick={resetNumberClick} className="btn">
        Reset
      </button>
      <button onClick={randomNumberClick} className="btn">
        Randomize
      </button>
      <button onClick={incrementNumberClick} className="btn">
        +
      </button>
      <p>
        You have {number} {alerts}
      </p>
    </div>
  );
}
